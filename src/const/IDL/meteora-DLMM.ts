export type MeteoraDLMM = {
  ...
  instructions: [
    ...
    },
    {
      ...
      args: [{ name: 'length_to_remove'; type: 'u16' }, { name: 'side'; type: 'u8' }];
    },
    {
    ...
    },
    {
      ...
      args: [{ name: 'length_to_add'; type: 'u16' }, { name: 'side'; type: 'u8' }];
    },
    {
    ...
    },
    {
      ...
      args: [{ name: 'active_id'; type: 'i32' }, { name: 'bin_step'; type: 'u16' }];
    },
    {
    ...
    },
    {
      ...
      args: [{ name: 'lower_bin_id'; type: 'i32' }, { name: 'width'; type: 'i32' }];
    },
    {
    ...
    },
    {
      ...
      accounts: [
        { name: 'lb_pair'; writable: true },
        {
          ...
          writable: true;
          pda: {
            seeds: [{ kind: 'account'; path: 'lb_pair' }, { kind: 'arg'; path: 'reward_index' }];
          };
        },
        { name: 'reward_mint' },
    ...
    },
    {
      ...
      accounts: [{ name: 'lb_pair'; writable: true }, { name: 'admin'; signer: true }];
    ...
    },
    {
      ...
      accounts: [
        { name: 'lbPair'; writable: true; relations: ['bin_array_bitmap_extension'] },
        { name: 'binArrayBitmapExtension'; optional: true },
        { name: 'reserveX'; writable: true; relations: ['lbPair'] },
        { name: 'reserveY'; writable: true; relations: ['lbPair'] },
        { name: 'userTokenIn'; writable: true },
        { name: 'userTokenOut'; writable: true },
        { name: 'tokenXMint'; relations: ['lbPair'] },
        { name: 'tokenYMint'; relations: ['lbPair'] },
        { name: 'oracle'; writable: true; relations: ['lbPair'] },
        { name: 'hostFeeIn'; writable: true; optional: true },
        { name: 'user'; signer: true },
        { name: 'tokenXProgram'; address: 'TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA' },
        { name: 'tokenYProgram'; address: 'TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA' },
        {
          name: 'eventAuthority';
          pda: {
            seeds: [
      ...
      args: [{ name: 'amountIn'; type: 'u64' }, { name: 'minAmountOut'; type: 'u64' }];
    },
    {
      name: 'swap2';
      ...
      accounts: [
        ...
        { name: 'tokenXProgram' },
        { name: 'tokenYProgram' },
        { name: 'memoProgram'; address: 'MemoSq4gqABAXKb96qnH8TysNcWxMyWCqXgDLGmfcHr' },
        {
          name: 'eventAuthority';
          pda: {
            seeds: [
      ...
      args: [
        ...
        { name: 'remainingAccountsInfo'; type: { defined: { name: 'RemainingAccountsInfo' } } },
      ];
    },
    {
      name: 'swapExactOut';
      ...
      args: [{ name: 'maxInAmount'; type: 'u64' }, { name: 'outAmount'; type: 'u64' }];
    },
    {
      name: 'swapExactOut2';
      discriminator: [43, 215, 247, 132, 137, 60, 243, 81];
      accounts: [
        { name: 'lbPair'; writable: true; relations: ['binArrayBitmapExtension'] },
        { name: 'binArrayBitmapExtension'; optional: true },
        { name: 'reserveX'; writable: true; relations: ['lbPair'] },
        { name: 'reserveY'; writable: true; relations: ['lbPair'] },
        { name: 'userTokenIn'; writable: true },
    ...
    },
    {
      ...
      args: [
        { name: 'amountIn'; type: 'u64' },
        { name: 'activeId'; type: { option: 'i32' } },
        { name: 'maxPriceImpactBps'; type: 'u16' },
      ];
    },
    {
    ...
    },
    {
      ...
      args: [{ name: 'feeParameter'; type: { defined: { name: 'BaseFeeParameter' } } }];
    },
    {
      ...
      args: [{ name: 'feeParameter'; type: { defined: { name: 'DynamicFeeParameter' } } }];
    },
    {
      ...
      accounts: [
        { name: 'position'; writable: true },
        { name: 'lbPair'; writable: true; relations: ['position'] },
        { name: 'owner'; signer: true },
      ];
      args: [{ name: 'minBinId'; type: 'i32' }, { name: 'maxBinId'; type: 'i32' }];
    },
    {
      ...
      accounts: [
        ...
        { name: 'binArrayLower'; writable: true },
        { name: 'binArrayUpper'; writable: true },
        { name: 'owner'; signer: true },
      ];
      args: [];
    },
    ...
    },
    {
      ...
      accounts: [
        { name: 'lbPair'; writable: true; relations: ['binArray'] },
        { name: 'admin'; signer: true },
        { name: 'binArray'; writable: true },
        {
          name: 'eventAuthority';
          pda: {
            seeds: [
      ...
      args: [{ name: 'rewardIndex'; type: 'u64' }, { name: 'newDuration'; type: 'u64' }];
    },
    {
      ...
      args: [{ name: 'rewardIndex'; type: 'u64' }, { name: 'newFunder'; type: 'pubkey' }];
    },
    {
      ...
      accounts: [
        { name: 'lbPair'; writable: true; relations: ['binArray'] },
        { name: 'rewardVault'; writable: true },
        { name: 'rewardMint' },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: 'tokenYMint'; relations: ['lbPair'] },
        {
          ...
          pda: {
            seeds: [
              ...
              { kind: 'account'; path: 'tokenXProgram' },
              { kind: 'account'; path: 'tokenXMint' },
            ];
            program: {
              kind: 'const';
              value: [
        ...
        },
        {
          ...
          pda: {
            seeds: [
              ...
              { kind: 'account'; path: 'tokenYProgram' },
              { kind: 'account'; path: 'tokenYMint' },
            ];
            program: {
              kind: 'const';
              value: [
        ...
        { name: 'operator'; docs: ['operator']; signer: true; relations: ['claimFeeOperator'] },
        { name: 'tokenXProgram' },
        { name: 'tokenYProgram' },
        { name: 'memoProgram'; address: 'MemoSq4gqABAXKb96qnH8TysNcWxMyWCqXgDLGmfcHr' },
      ];
      args: [
        { name: 'maxAmountX'; type: 'u64' },
        { name: 'maxAmountY'; type: 'u64' },
        { name: 'remainingAccountsInfo'; type: { defined: { name: 'RemainingAccountsInfo' } } },
      ];
    },
  ];
  ...
  types: [
    ...
    },
    {
      ...
      type: {
        kind: 'struct';
        fields: [{ name: 'bin_id'; type: 'i32' }, { name: 'bps_to_remove'; type: 'u16' }];
      };
    },
    {
      name: 'ClaimFee';
    ...
    },
    {
      ...
      type: {
        kind: 'struct';
        fields: [{ name: 'bin_id'; type: 'i32' }, { name: 'amount'; type: 'u32' }];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        kind: 'struct';
        fields: [{ name: 'position'; type: 'pubkey' }, { name: 'owner'; type: 'pubkey' }];
      };
    },
    {
      name: 'PositionCreate';
    ...
    },
    {
      ...
      type: {
        kind: 'struct';
        fields: [{ name: 'amount_x'; type: 'u64' }, { name: 'amount_y'; type: 'u64' }];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        kind: 'struct';
        fields: [
          { name: 'accountsType'; type: { defined: { name: 'AccountsType' } } },
          { name: 'length'; type: 'u8' },
        ];
      };
    },
