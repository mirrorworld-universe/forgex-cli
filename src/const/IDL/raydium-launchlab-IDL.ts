export type RaydiumLaunchlabIDL = {
  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        { name: 'quote_token_mint'; docs: ['The mint of the quote token'] },
        { name: 'base_token_program'; docs: ['SPL Token program for base token transfers'] },
        {
    ...
    },
    {
      ...
      args: [
        ...
        { name: 'maximum_amount_in'; type: 'u64' },
        { name: 'share_fee_rate'; type: 'u64' },
      ];
    },
    {
      ...
      accounts: [
        ...
        { name: 'platform_config'; docs: ['The platform config account'] },
        { name: 'quote_vault'; writable: true },
        {
          ...
          pda: {
            seeds: [
              { kind: 'account'; path: 'platform_fee_wallet' },
              {
                kind: 'const';
                value: [
                  6,
        ...
        { name: 'quote_mint'; docs: ['The mint of quote token vault'] },
        {
          name: 'token_program';
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          pda: {
            seeds: [
              { kind: 'const'; value: [112, 111, 111, 108, 95, 118, 101, 115, 116, 105, 110, 103] },
        ...
        { name: 'user_base_token'; writable: true; signer: true },
        {
          name: 'base_token_mint';
          docs: [
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: 'global_config'; docs: ['Global config account stores owner'] },
        {
          name: 'quote_vault';
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          pda: {
            seeds: [
              ...
              { kind: 'account'; path: 'quote_token_mint' },
              { kind: 'arg'; path: 'curve_type' },
              { kind: 'arg'; path: 'index' },
            ];
          };
        },
        ...
        { name: 'protocol_fee_owner'; docs: ['Account that will receive protocol fees'] },
        { name: 'migrate_fee_owner'; docs: ['Account that will receive migrate fees'] },
        {
      ...
      args: [
        ...
        { name: 'index'; type: 'u16' },
        { name: 'migrate_fee'; type: 'u64' },
        { name: 'trade_fee_rate'; type: 'u64' },
      ];
    },
    {
        ...
        { name: 'platform_nft_wallet' },
        {
          ...
          pda: {
            seeds: [
              ...
              { kind: 'account'; path: 'platform_admin' },
            ];
          };
        },
        {
      ...
      args: [{ name: 'platform_params'; type: { defined: { name: 'PlatformParams' } } }];
    },
    {
      ...
      accounts: [
        ...
        { name: 'pool_state'; docs: ['The pool state account']; writable: true },
        {
          name: 'vesting_record';
          docs: ['The vesting record account'];
          writable: true;
      ...
      args: [{ name: 'share_amount'; type: 'u64' }];
    },
    {
      name: 'initialize';
      docs: [
      ...
      args: [
        { name: 'base_mint_param'; type: { defined: { name: 'MintParams' } } },
        { name: 'curve_param'; type: { defined: { name: 'CurveParams' } } },
        { name: 'vesting_param'; type: { defined: { name: 'VestingParams' } } },
      ];
    },
    {
      name: 'migrate_to_amm';
      ...
      accounts: [
        ...
        { name: 'base_mint'; docs: ['The mint for the base token (token being sold)'] },
        { name: 'quote_mint'; docs: ['The mint for the quote token (token used to buy)'] },
        { name: 'openbook_program'; address: 'srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX' },
        {
          name: 'market';
        ...
        { name: 'amm_program'; address: '675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8' },
        {
          name: 'amm_pool';
          writable: true;
          pda: {
            seeds: [
              { kind: 'account'; path: 'amm_program' },
        ...
        { name: 'amm_create_fee_destination'; writable: true },
        {
          name: 'authority';
          docs: [
            'PDA that acts as the authority for pool vault operations',
        ...
        { name: 'pool_lp_token'; writable: true },
        {
      ...
      args: [
        { name: 'base_lot_size'; type: 'u64' },
        { name: 'quote_lot_size'; type: 'u64' },
        { name: 'market_vault_signer_nonce'; type: 'u8' },
      ];
    },
    {
      ...
      accounts: [
        ...
        { name: 'cpswap_program'; address: 'CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C' },
        {
          name: 'cpswap_pool';
          docs: [
            'PDA account:',
        ...
        },
        {
          ...
          pda: {
            ...
            program: { kind: 'account'; path: 'cpswap_program' };
          };
        },
        {
          name: 'cpswap_lp_mint';
        ...
        { name: 'cpswap_config' },
        { name: 'cpswap_create_pool_fee'; writable: true },
        {
        ...
        { name: 'lock_lp_vault'; writable: true },
        {
          name: 'authority';
          docs: [
            'PDA that acts as the authority for pool vault operations',
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: 'global_config'; docs: ['Global config account to be changed']; writable: true },
      ];
      args: [{ name: 'param'; type: 'u8' }, { name: 'value'; type: 'u64' }];
    },
    {
  ...
  accounts: [
    ...
    { name: 'PoolState'; discriminator: [247, 237, 227, 245, 215, 195, 222, 70] },
    { name: 'VestingRecord'; discriminator: [106, 243, 221, 205, 230, 126, 85, 83] },
  ];
  events: [
    { name: 'ClaimVestedEvent'; discriminator: [21, 194, 114, 87, 120, 211, 226, 32] },
    { name: 'CreateVestingEvent'; discriminator: [150, 152, 11, 179, 52, 210, 191, 125] },
    { name: 'PoolCreateEvent'; discriminator: [151, 215, 226, 9, 118, 161, 115, 174] },
    { name: 'TradeEvent'; discriminator: [189, 219, 127, 211, 78, 230, 97, 238] },
  ];
  errors: [
    { code: 6000; name: 'NotApproved'; msg: 'Not approved' },
    { code: 6001; name: 'InvalidOwner'; msg: 'Input account owner is not the program address' },
    { code: 6002; name: 'InvalidInput'; msg: 'InvalidInput' },
    {
      code: 6003;
      name: 'InputNotMatchCurveConfig';
      msg: 'The input params are not match with curve type in config';
    },
    { code: 6004; name: 'ExceededSlippage'; msg: 'Exceeds desired slippage limit' },
    { code: 6005; name: 'PoolFunding'; msg: 'Pool funding' },
    { code: 6006; name: 'PoolMigrated'; msg: 'Pool migrated' },
    { code: 6007; name: 'MigrateTypeNotMatch'; msg: 'Migrate type not match' },
    { code: 6008; name: 'MathOverflow'; msg: 'Math overflow' },
    { code: 6009; name: 'NoAssetsToCollect'; msg: 'No assets to collect' },
    { code: 6010; name: 'VestingRatioTooHigh'; msg: 'Vesting ratio too high' },
    { code: 6011; name: 'VestingSettingEnded'; msg: 'Vesting setting ended' },
    { code: 6012; name: 'VestingNotStarted'; msg: 'Vesting not started' },
    { code: 6013; name: 'NoVestingSchedule'; msg: 'No vesting schedule' },
    { code: 6014; name: 'InvalidPlatformInfo'; msg: 'The platform info input is invalid' },
    { code: 6015; name: 'PoolNotMigrated'; msg: 'Pool not migrated' },
  ];
  types: [
    {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: 'total_base_sell'; type: 'u64' },
          { name: 'total_quote_fund_raising'; type: 'u64' },
          { name: 'migrate_type'; type: 'u8' },
        ];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        ...
        variants: [
          {
            name: 'Constant';
            fields: [{ name: 'data'; type: { defined: { name: 'ConstantCurve' } } }];
          },
          { name: 'Fixed'; fields: [{ name: 'data'; type: { defined: { name: 'FixedCurve' } } }] },
          {
            name: 'Linear';
            fields: [{ name: 'data'; type: { defined: { name: 'LinearCurve' } } }];
          },
        ];
      };
    },
    ...
    },
    {
      ...
      type: {
        kind: 'struct';
        fields: [
          { name: 'epoch'; docs: ['Account update epoch']; type: 'u64' },
          {
            name: 'curve_type';
          ...
          { name: 'migrate_fee'; docs: ['The fee of migrate to amm']; type: 'u64' },
          {
            name: 'trade_fee_rate';
          ...
          { name: 'quote_mint'; docs: ['Mint information for quote token']; type: 'pubkey' },
          { name: 'protocol_fee_owner'; docs: ['Protocol Fee owner']; type: 'pubkey' },
          { name: 'migrate_fee_owner'; docs: ['Migrate Fee owner']; type: 'pubkey' },
          {
            name: 'migrate_to_amm_wallet';
            docs: ['Migrate to amm control wallet'];
            type: 'pubkey';
          },
          { name: 'migrate_to_cpswap_wallet'; docs: ['Migrate to cpswap wallet']; type: 'pubkey' },
          { name: 'padding'; docs: ['padding for future updates']; type: { array: ['u64', 16] } },
        ];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        kind: 'struct';
        fields: [
          { name: 'platform_scale'; type: 'u64' },
          { name: 'creator_scale'; type: 'u64' },
          { name: 'burn_scale'; type: 'u64' },
        ];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        kind: 'struct';
        fields: [
          { name: 'epoch'; docs: ['The epoch for update interval']; type: 'u64' },
          { name: 'platform_fee_wallet'; docs: ['The platform fee wallet']; type: 'pubkey' },
          {
            name: 'platform_nft_wallet';
            docs: [
          ...
          { name: 'burn_scale'; docs: ['Scale of liquidity directly to burn']; type: 'u64' },
          { name: 'fee_rate'; docs: ['The platform fee rate']; type: 'u64' },
          { name: 'name'; docs: ['The platform name']; type: { array: ['u8', 64] } },
          { name: 'web'; docs: ['The platform website']; type: { array: ['u8', 256] } },
          { name: 'img'; docs: ['The platform img link']; type: { array: ['u8', 256] } },
    ...
    },
    {
      ...
      type: {
        kind: 'enum';
        variants: [
          { name: 'FeeWallet'; fields: ['pubkey'] },
          { name: 'NFTWallet'; fields: ['pubkey'] },
          { name: 'MigrateNftInfo'; fields: [{ defined: { name: 'MigrateNftInfo' } }] },
          { name: 'FeeRate'; fields: ['u64'] },
          { name: 'Name'; fields: ['string'] },
          { name: 'Web'; fields: ['string'] },
          { name: 'Img'; fields: ['string'] },
        ];
      };
    },
    {
      ...
      type: {
        kind: 'struct';
        fields: [
          { name: 'migrate_nft_info'; type: { defined: { name: 'MigrateNftInfo' } } },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          { name: 'epoch'; docs: ['Account update epoch']; type: 'u64' },
          { name: 'auth_bump'; docs: ['Bump seed used for PDA address derivation']; type: 'u8' },
          {
            name: 'status';
            docs: [
          ...
          { name: 'base_decimals'; docs: ['Decimals of the pool base token']; type: 'u8' },
          { name: 'quote_decimals'; docs: ['Decimals of the pool quote token']; type: 'u8' },
          { name: 'migrate_type'; docs: ['Migrate to AMM or CpSwap']; type: 'u8' },
          { name: 'supply'; docs: ['Supply of the pool base token']; type: 'u64' },
          { name: 'total_base_sell'; docs: ['Total sell amount of the base token']; type: 'u64' },
          {
            name: 'virtual_base';
            docs: [
          ...
          { name: 'migrate_fee'; docs: ['The fee of migrate to amm']; type: 'u64' },
          {
            ...
            type: { defined: { name: 'VestingSchedule' } };
          },
          {
            name: 'global_config';
            docs: [
          ...
          { name: 'base_mint'; docs: ['Public key of the base mint address']; type: 'pubkey' },
          { name: 'quote_mint'; docs: ['Public key of the quote mint address']; type: 'pubkey' },
          {
            name: 'base_vault';
            docs: [
          ...
          { name: 'creator'; docs: ['The creator of base token']; type: 'pubkey' },
          { name: 'padding'; docs: ['padding for future updates']; type: { array: ['u64', 8] } },
        ];
      };
    },
    {
      ...
      type: { kind: 'enum'; variants: [{ name: 'Fund' }, { name: 'Migrate' }, { name: 'Trade' }] };
    },
    {
      name: 'TradeDirection';
      docs: [
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          { name: 'pool_state'; type: 'pubkey' },
          { name: 'total_base_sell'; type: 'u64' },
          { name: 'virtual_base'; type: 'u64' },
          { name: 'virtual_quote'; type: 'u64' },
          { name: 'real_base_before'; type: 'u64' },
          { name: 'real_quote_before'; type: 'u64' },
          { name: 'real_base_after'; type: 'u64' },
          { name: 'real_quote_after'; type: 'u64' },
          { name: 'amount_in'; type: 'u64' },
          { name: 'amount_out'; type: 'u64' },
          { name: 'protocol_fee'; type: 'u64' },
          { name: 'platform_fee'; type: 'u64' },
          { name: 'share_fee'; type: 'u64' },
          { name: 'trade_direction'; type: { defined: { name: 'TradeDirection' } } },
          { name: 'pool_status'; type: { defined: { name: 'PoolStatus' } } },
        ];
      };
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: 'cliff_period'; type: 'u64' },
          { name: 'unlock_period'; type: 'u64' },
        ];
      };
    },
    {
      ...
      type: {
        ...
        fields: [
          { name: 'epoch'; docs: ['Account update epoch']; type: 'u64' },
          { name: 'pool'; docs: ['The pool state account']; type: 'pubkey' },
          { name: 'beneficiary'; docs: ['The beneficiary of the vesting account']; type: 'pubkey' },
          { name: 'claimed_amount'; docs: ['The amount of tokens claimed']; type: 'u64' },
          {
          ...
          pda: {
            seeds: [
              ...
              { kind: 'account', path: 'market' },
              {
                kind: 'const',
                value: [
                  97, 109, 109, 95, 97, 115, 115, 111, 99, 105, 97, 116, 101, 100, 95, 115, 101,
                  101, 100,
                ],
              },
            ],
          ...
          pda: {
            seeds: [
              ...
              { kind: 'account', path: 'market' },
              {
                kind: 'const',
                value: [
                  111, 112, 101, 110, 95, 111, 114, 100, 101, 114, 95, 97, 115, 115, 111, 99, 105,
          ...
          pda: {
            seeds: [
              ...
              { kind: 'account', path: 'market' },
              {
                kind: 'const',
                value: [
                  108, 112, 95, 109, 105, 110, 116, 95, 97, 115, 115, 111, 99, 105, 97, 116, 101,
          ...
          pda: {
            seeds: [
              ...
              { kind: 'account', path: 'market' },
              {
                kind: 'const',
                value: [
                  99, 111, 105, 110, 95, 118, 97, 117, 108, 116, 95, 97, 115, 115, 111, 99, 105, 97,
          ...
          pda: {
            seeds: [
              ...
              { kind: 'account', path: 'market' },
              {
                kind: 'const',
                value: [
                  112, 99, 95, 118, 97, 117, 108, 116, 95, 97, 115, 115, 111, 99, 105, 97, 116, 101,
                  100, 95, 115, 101, 101, 100,
                ],
              },
            ],
          ...
          pda: {
            seeds: [
              ...
              { kind: 'account', path: 'market' },
              {
                kind: 'const',
                value: [
                  116, 97, 114, 103, 101, 116, 95, 97, 115, 115, 111, 99, 105, 97, 116, 101, 100,
                  95, 115, 101, 101, 100,
                ],
              },
            ],
            ...
            seeds: [
              {
                kind: 'const',
                value: [
                  97, 109, 109, 95, 99, 111, 110, 102, 105, 103, 95, 97, 99, 99, 111, 117, 110, 116,
                  95, 115, 101, 101, 100,
                ],
              },
            ],
